...
class PepperDetection extends StatefulWidget {
  @override
  _PepperDetectionState createState() => _PepperDetectionState();
}
...
class _PepperDetectionState extends State<PepperDetection> {
  ...
  loadmodel() async {
    await Tflite.loadModel(
        model: 'assets/tflite_pepper.tflite',
        labels: 'assets/labels_pepper.txt');
  }
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Container(
                child: Text('Pepper Disease Detector',
                    style: GoogleFonts.roboto(
                      fontSize: 20,
